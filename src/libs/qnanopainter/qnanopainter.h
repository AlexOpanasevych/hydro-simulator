...
#include "qnanofont.h"
#include <qnanopainter_global.h>

struct NVGcontext;

class QNANOPAINTER_EXPORT QNanoPainter
{
...
public:
    ...
    void drawImage(QNanoImage &image, float x, float y, float alpha = 1.f);
    void drawImage(QNanoImage &image, float x, float y, float width, float height, float alpha = 1.f);
    void drawImage(QNanoImage &image, const QRectF destinationRect, float alpha = 1.f);
    void drawImage(QNanoImage &image, const QRectF sourceRect, const QRectF destinationRect, float alpha = 1.f);
...
private:
    ...
    void drawImageId(int imageId, float x, float y, float width, float height, float alpha = 1.f);
