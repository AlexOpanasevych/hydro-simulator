...
#ifdef QNANO_USE_RENDERNODE
class QNANOPAINTER_EXPORT QNanoQuickItemPainter : public QSGRenderNode, protected QOpenGLFunctions
#else
class QNANOPAINTER_EXPORT QNanoQuickItemPainter : public QQuickFramebufferObject::Renderer, protected QOpenGLFunctions
#endif
{
