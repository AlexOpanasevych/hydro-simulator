...
class SORTFILTERPROXYMODEL_EXPORT SwitchRoleAttached : public QObject
{
    Q_OBJECT
...
class SORTFILTERPROXYMODEL_EXPORT SwitchRole : public SingleRole, public FilterContainer
{
    Q_OBJECT
