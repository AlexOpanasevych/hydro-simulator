...
Rectangle{
    ...
    ColumnLayout{
        ...
        C.Button {
            ...
            buttonRadius: 3
            Layout.maximumHeight: listView.count > 0 && sceneArea.scene.scenePlayer.mode === 2 ? 30 : 0
            visible: listView.count > 0 && sceneArea.scene.scenePlayer.mode === 2
            onPressed: {
