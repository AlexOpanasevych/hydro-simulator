...
Item {
    ...
    */
    ...
    /*!
        ...
        The default value is \c{0.0}
    */
    property alias fullTurn: internal.fullTurn
    /*!
        \signal pressed
    ...
    */
    ...
    Rectangle{
        ...
        MouseArea{
            ...
            onPositionChanged: { internal.updateValue(mouseX, mouseY) }
        }
    }
    /*!
      internal data
    ...
    QtObject{
        ...
        */
        ...
        function updateValue(mouseX, mouseY){
            ...
            if (internal.prevValue < 15 && internal.value - internal.prevValue > 340){
                internal.fullTurn--;
            }else if ((internal.prevValue > 345 && internal.prevValue - internal.value > 340)/* || internal.value - internal.prevValue < -180*/){
                internal.fullTurn++;
            }
        }
    }
